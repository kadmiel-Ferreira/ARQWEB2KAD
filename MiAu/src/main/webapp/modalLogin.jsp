  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #F4A460 ;">
        <h2 class="modal-title" id="exampleModalLabel">MiAuDote 🐶🐱</h2>
      ...
      <div class="modal-body" >
		...
		<form action="ControllerServlet" method="post" >
			...
			<div class="mb-3">
				<button type="submit" class="btn w-100" name="action" style="background: #F4A460 !important;" 
					value="login">Login</button>
			</div>

			<div class="mb-3">
				<a href="cadastrarPessoa.jsp" class="btn w-100" style="background: rgba(25, 25, 112, 0.5);">Cadastrar</a>
			</div>
		</form>
	</div>
      </div>
